    ...
    IRentalRepository rentalRepository) : IMotoService
{
    ...
    public async Task<IEnumerable<MotoDto>> GetAllAsync(CancellationToken cancellationToken)
    {
        ...
        return motos.Select(moto => new MotoDto(moto.Id, moto.Year, moto.Model, moto.Plate));
    }

    public async Task<MotoDto?> GetByIdAsync(Guid idMoto, CancellationToken cancellationToken)
    {
        ...
        return new MotoDto(moto.Id, moto.Year, moto.Model, moto.Plate);
    }

    public async Task<MotoDto?> GetByPlateAsync(string placa, CancellationToken cancellationToken)
    {
